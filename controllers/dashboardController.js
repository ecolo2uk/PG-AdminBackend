...
// ✅ CORRECTED: Add missing export for getDashboardAnalytics
export const getDashboardAnalytics = async (req, res) => {
  try {
    ...
    // ✅ FIXED: Get all transactions first
    ...
    // ✅ FIXED: Manual aggregation with unified status
    let analytics = {
